### 26 June 2022 Table 3 DH2 Design
####
...
write(c("LLFC, TT0-3;nn1,nn2,Nrep, DH",nn1,nn2,Nrep),"DH2pva20k",ncolumns=4,append=T)
write(c("ll in DH=", ll, DH), "DH2pva20k", ncolumns=8, append=T)
write(round(t(DH.pv),4), "DH2pva20k", ncolumns=12, append=T)


write.csv(DH.pv,file="LLFC_DH2a20k.csv")

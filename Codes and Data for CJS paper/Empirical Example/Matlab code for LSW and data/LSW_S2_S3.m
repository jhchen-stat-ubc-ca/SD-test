...
s1 = csvread('S2.csv');  %sample 1 data for 1973
s2 = csvread('S3.csv');  %sample 2 data for 1978
...
csvwrite('pvaluesS2_S3.txt',round(pvalue_all0,4));
csvwrite('cvaluesS2_S3.txt',round(cvalues,4));
csvwrite('S2_S3_N0bnew1.txt',round(T_N0,4));
csvwrite('S2_S3BBstat0b.txt',BBstat0);

...
for j = 1:n % Loop through number of times to run calculations
    ...
    for i = 1:6
        ...
        switch i
            case 1
                [sample1,sample2]=randDH1(0.25,n1,n2,1);   %DH1(0.25)            
            case 2
                [sample1,sample2]=randDH1(0.55,n1,n2,1);   %DH1(0.55)
            case 3
                [sample1,sample2]=randDH1(0.8,n1,n2,1);    %DH1(0.80)
            case 4
                [sample1,sample2]=randDH2(0.25,n1,n2,1);    %DH2(0.25)
            case 5
                [sample1,sample2]=randDH2(0.55,n1,n2,1);    %DH2(0.55)
            case 6
                [sample1,sample2]=randDH2(0.8,n1,n2,1);    %DH2(0.80)
...
csvwrite('LSW_DH12.csv',lessthanallf);

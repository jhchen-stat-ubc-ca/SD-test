...
### DD models
Null = T  ##Null =F, DD1(1),DD1(2),DD1(3); =T DD0(1),DD0(2),DD0(3)
if(Null) {
DD = rbind(
...
#
write(c("LLFC, TT0,1,2,3;nn1,nn2,Nrep,null=",nn1,nn2,Nrep,Null),"DD0pv20k",ncolumns=3,append=T)
write(round(t(DD),3), "DD0pv20k", ncolumns=8, append=T)
write(round(t(DD.pv),4), "DD0pv20k", ncolumns=12, append=T)

write.csv(DD.pv,file="LLFC_DD020k.csv")

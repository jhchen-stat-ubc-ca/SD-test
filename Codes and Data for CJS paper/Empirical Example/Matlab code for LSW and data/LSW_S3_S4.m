...
s1 = csvread('S3.csv');  %sample 1 data for 1978
s2 = csvread('S4.csv');  %sample 2 data for 1983
...
csvwrite('pvaluesS3_S4.txt',round(pvalue_all0,4));
csvwrite('cvaluesS3_S4.txt',round(cvalues,4));
csvwrite('S3_S4_N0bnew1.txt',round(T_N0,4));
csvwrite('S3_S4BBstat0b.txt',BBstat0);

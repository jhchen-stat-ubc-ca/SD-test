...
n = 20000;
allstorage = zeros(n,6);

DDseg=csvread('DDseg.csv');
...
for j = 1:n % Loop through number of times to run calculations
    ...
    for i = 1:6
        ...
        switch i
            case 1
                [sample1,sample2]=randDD0(DDseg(1,:),n1,n2,1);   %DD0[1]            
            case 2
                [sample1,sample2]=randDD0(DDseg(2,:),n1,n2,1);   %DD0[2]
            case 3
                [sample1,sample2]=randDD0(DDseg(3,:),n1,n2,1);   %DD0[3]
            case 4
                [sample1,sample2]=randDD0(DDseg(4,:),n1,n2,1);   %DD1[1]
            case 5
                [sample1,sample2]=randDD0(DDseg(5,:),n1,n2,1);   %DD1[2]
            case 6
                [sample1,sample2]=randDD0(DDseg(6,:),n1,n2,1);   %DD1[3] 
        end
        %------------------------ Subroutine ------------------------%
...
csvwrite('LSW_DD12.csv',lessthanallf);

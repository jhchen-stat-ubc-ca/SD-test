...
s1 = csvread('S1.csv');  %sample 1 data for 1968
s2 = csvread('S2.csv');  %sample 2 data for 1973
...
csvwrite('pvaluesS1_S2.txt',round(pvalue_all0,4));
csvwrite('cvaluesS1_S2.txt',round(cvalues,4));
csvwrite('S1_S2_N0bnew1.txt',round(T_N0,4));
csvwrite('S1_S28BBstat0b.txt',BBstat0);
